CRUD vem do inglês e representa as quatro principais operações realizadas em um banco de dados: Create, Read, Update e Delete. Essas operações são fundamentais para que um sistema consiga armazenar, exibir, editar e remover informações do banco de dados.
Create (Criar Dados):
